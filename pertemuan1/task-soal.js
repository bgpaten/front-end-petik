 ...
 */
const users = [
  { name: 'Asep', age: 20, major: 'Full Stack Developer' },
  { name: 'Samsul', age: 22, major: 'Front End Developer' },
  { name: 'Joni', age: 25, major: 'Back End Developer' },
  { name: 'Nana', age: 24, major: 'UI/UX Designer' },
  { name: 'Angela', age: 28, major: 'Leader Project' },
];
